 ...
 *
 * Bug Hunting Tests:
 * 1. Pass a custom onSuccess prop (increasing score by 8),
 *    click on the right hole
 *    verify score went up by 8
 */

function App(props) {
    const { holesCount, onSuccess, onFail } = props;
...
App.defaultProps = {
    holesCount: 10,
    renderListItem: (liText) => <li>{liText}</li>,
    onSuccess: score => score + 10,
    onFail: score => score - 2,
};
